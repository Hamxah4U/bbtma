...
<div id="wrapper">
  ...
  <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">          
            <h5 class="h5 mb-0 text-gray-800"><strong>School Fees Window Dashboard</strong></h5>          
          </a>
        </div>
            ...
            <?php
              ...
              foreach($students as $std):?>
                <tr>
                  ...
                  <td>
                    <a href="/payschoolfees?code=<?= $std['stu_ID']; ?>" title="Student Wallet"><p class="icofont-eye" style="float: left; font-size:30px; color:red"></p></a>
                  </td>
                </tr>
              <?php endforeach ?>
                </tbody>
